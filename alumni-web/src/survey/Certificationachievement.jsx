...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ca-bell { width: 48px; height: 48px; background: rgba(15,22,66,0.1); border: 1.24px solid rgba(255,255,255,0.1); box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); border-radius: 14px; cursor: pointer; display: flex; align-items: center; justify-content: center; position: relative; flex-shrink: 0; }
  .ca-bell-dot { position: absolute; top: -4px; right: -4px; width: 20px; height: 20px; background: #2B72FB; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Arimo', Arial, sans-serif; font-size: 10px; color: #fff; }
  ...
  .ca-progress-track { width: 100%; height: 11px; background: #D9CA81; border-radius: 10px; margin-bottom: 10px; }
  .ca-progress-fill { width: 43%; height: 100%; background: #51A2FF; border-radius: 10px; }
        ...
        <div className="ca-content">
          <div className="ca-header">
            ...
            <div className="ca-progress">
              <div className="ca-progress-row"><span>Section 3 of 7</span><span>43% complete</span></div>
              <div className="ca-progress-track"><div className="ca-progress-fill" /></div>
