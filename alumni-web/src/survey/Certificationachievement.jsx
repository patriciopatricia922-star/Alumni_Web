...
const CERTIFICATIONS = [
  ...
  'Adobe Agriscience and Technology Careers',
  ...
  'IC3 Digital Literacy - Fast Track',
  'IC3 Digital Literacy - Spark',
  'IC3 Digital Literacy - PHP Developer Fundamentals',
  'Autodesk Certified User / Professional - AutoCAD',
  'Autodesk Certified User / Professional - Revit',
  'Autodesk Certified User / Professional - Maya',
  'Autodesk Certified User / Professional - Fusion',
  ...
  'Pearson Languages Certifications',
  'Other',
];
