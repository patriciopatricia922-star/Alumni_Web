...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 1100px) { .fu-topbar { padding: 24px 32px 0; } .fu-title { padding: 14px 32px 0; font-size: 26px; } .fu-progress { margin: 12px 32px 0; } .fu-body { padding: 20px 32px 60px; } .fu-card { padding: 32px 32px 28px; } }
  @media (max-width: 900px) { .fu-topbar { padding: 20px 24px 0; } .fu-title { padding: 12px 24px 0; font-size: 24px; } .fu-progress { margin: 10px 24px 0; } .fu-body { padding: 18px 24px 60px; } .fu-card { padding: 28px 24px 24px; gap: 28px; } }
  @media (max-width: 767px) { .fu-content { margin-left: 0; } .fu-topbar { padding: 20px 16px 0; } .fu-badge { padding: 6px 12px; font-size: 10px; } .fu-bell { display: none; } .fu-title { padding: 12px 16px 0; font-size: 20px; } .fu-progress { margin: 10px 16px 0; padding: 14px 16px; } .fu-progress-row { font-size: 13px; } .fu-progress-label { font-size: 13px; } .fu-body { padding: 16px 16px 80px; } .fu-card { padding: 20px 16px 20px; gap: 24px; } .fu-section-title { font-size: 17px; } .fu-btn-prev { width: 100px; height: 44px; font-size: 14px; } .fu-btn-next { width: 100px; height: 44px; font-size: 14px; } }
        ...
        <div className="fu-content">
          ...
          <div className="fu-body">
            <div className="fu-card" ref={cardRef}>
              {errors.size > 0 && <div className="fu-error-banner"><strong>Please answer all required questions before proceeding.</strong></div>}
              <div>
              ...
              <div className="fu-questions">
                ...
                <div className="fu-field">
                  ...
                  <textarea className="fu-textarea" placeholder="Enter your answer" value={form.suggestions} onChange={e => set('suggestions', e.target.value)} />
                </div>
              </div>
