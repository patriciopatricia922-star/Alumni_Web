  ...
  useEffect(() => {
    loadSectionData('job_experience').then(d => {
      if (d) setForm(f => ({
        ...f,
        ...d,
        // ← fallback for old key name saved before the snake_case migration
