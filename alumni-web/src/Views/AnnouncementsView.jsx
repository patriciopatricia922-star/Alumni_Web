...
//   <div
//   ref={bellRef}
//   className={isMobile ? "ann-bell mobile" : "ann-bell"}
//   style={{
//     position: "absolute",
//     top: isMobile ? undefined : "37px",
//     right: isMobile ? undefined : isTablet ? "32px" : "51px",
//     zIndex: 200,
//   }}
// >
//   <button
//     onClick={() => setShowDropdown((v) => !v)}
//     className={isMobile ? "ann-bell-btn mobile" : "ann-bell-btn"}
//     style={{
...
//       }}>
//         <span style={{
//           fontFamily: "Montserrat, Arial, sans-serif", fontSize: "10px",
...
//   {showDropdown && (
//     <div
//       className={isMobile ? "ann-ndrop mobile" : "ann-ndrop"}
//       style={{
//         position: "absolute",
...
//             fontFamily: "Montserrat, Arial, sans-serif", fontSize: "12px",
//             color: "#2B72FB", cursor: "pointer", padding: 0, fontWeight: 600,
//           }}>
//             Mark all read
//           </button>
//         )}
...
//               <div key={label}>
//                 <p style={{
//                   fontFamily: "Montserrat, Arial, sans-serif", fontWeight: 700, fontSize: "10px",
//                   color: "rgba(0,0,0,0.35)", textTransform: "uppercase", letterSpacing: "0.8px",
...
//                       background: "rgba(0,62,166,0.08)", border: "1px solid rgba(0,62,166,0.15)",
//                       display: "flex", alignItems: "center", justifyContent: "center",
...
//                       <p style={{
//                         fontFamily: "Montserrat, Arial, sans-serif", fontWeight: n.read ? 400 : 700,
//                         fontSize: "13px", color: "#0A0A0A", margin: "0 0 2px 0", lineHeight: "1.4",
//                       }}>
//                         {n.title}
//                       </p>
//                       <p style={{
//                         fontFamily: "Montserrat, Arial, sans-serif", fontSize: "12px", color: "#4A5565",
//                         margin: "0 0 4px 0", lineHeight: "1.4", display: "-webkit-box",
...
//           style={{
//             width: "100%", height: "36px", background: "#F9FAFB", border: "1px solid #D1D5DC",
//             borderRadius: "10px", fontFamily: "Montserrat, Arial, sans-serif", fontSize: "13px",
//             color: "#4A5565", cursor: "pointer", transition: "background 0.15s",
//           }}
...
const AnnouncementsView = ({
  ...
  return (
    <div className="ann-page" style={{ display: "flex", minHeight: "100vh" }}>
      ...
      >
        <div ref={bellRef} className="ann-bell">
          <button
