...
import { FaCalendarAlt, FaStar, FaFilter, FaChevronDown } from "react-icons/fa";
import {
  HiOutlineCalendar,
  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          "transform 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease, background 0.12s ease",
        display: "flex",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Header ── */}
        <div
          className={`events-header ${isMobile ? "mobile" : isTablet ? "tablet" : ""}`}
        >
          <h1
            className={`events-title ${isMobile ? "mobile" : isTablet ? "tablet" : ""}`}
          >
            Events
          </h1>
          <p className={`events-subtitle ${isMobile ? "mobile" : ""}`}>
            Stay updated with upcoming activities and gatherings designed to
            keep you engaged with the alumni community
          </p>
        </div>
        {/* ── Filter Bar ── */}
        <div
          className={
            isMobile ? "events-filter-bar mobile" : "events-filter-bar"
          }
          style={{
            display: "flex",
        ...
        >
          ...
          >
            <div
              ...
              className={
                isMobile ? "events-filter-trigger-wrap mobile" : undefined
              }
            >
              <div
                className={
                  isMobile
                    ? "events-filter-display mobile"
                    : "events-filter-display"
                }
                style={{
                  height: "40px",
                  display: "flex",
                  ...
                  {categories.map((cat, i) => (
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        borderTop:
                          i > 0 ? "1px solid rgba(0,62,166,0.08)" : "none",
                        cursor: "pointer",
                        transition: "background 0.15s",
                      }}
                      onMouseEnter={(e) => {
                      ...
                      >
                        <span
                          style={{
                            ...
                            fontSize: "11px",
                            color:
                              activeCategory === cat ? "#FFFFFF" : "#1e3a5f",
                          }}
                        >
                          {categoryCounts[cat]}
                        </span>
        ...
        <div
          className={isMobile ? "events-list-wrap mobile" : undefined}
