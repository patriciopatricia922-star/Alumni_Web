  ...
  return (
    <div style={{
      ...
      <div
        ...
        <div
          ref={bellRef}
          className={isMobile ? 'events-bell-wrapper mobile' : 'events-bell-wrapper'}
          style={{
            position: 'absolute',
          ...
          <button
            ...
            className={isMobile ? 'events-bell-btn mobile' : 'events-bell-btn'}
            style={{
          ...
          {showDropdown && (
            <div
              className={isMobile ? 'events-notif-dropdown mobile' : 'events-notif-dropdown'}
              style={{
                position:      'absolute',
