...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ca-header { position: sticky; top: 0; z-index: 40; background: #DAE5F1; padding-bottom: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); }
      ...
      <div className="ca-root">
        ...
        <div className="ca-content">
          ...
          <div className="ca-header">
            ...
            <p className="ca-subtitle">Please complete all sections to update your alumni status.</p>
