    ...
    <div style={{
      ...
      <div className="login-card" style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '12px 18px 26px', flexShrink: 0, textAlign: 'center' }}>
          ...
          <div style={{ padding: '4px 18px 18px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div>
              ...
              <div style={{ textAlign: 'right', marginTop: '6px' }}>
                <a href="/forgot-password" style={{ fontFamily: 'Arimo', fontSize: '11px', color: '#D9CA81', textDecoration: 'none' }}>Forgot Password?</a>
              </div>
            </div>
