...
const scrollbarStyles = `
  ...
  @media (max-width: 1024px) {
    .pp-page { margin-left: 200px; padding: 28px 32px; }
    .pp-card-header { padding: 32px 48px 20px; }
    .pp-card-body { padding: 0 48px 32px; }
    .pp-title { font-size: 24px; }
  }

  @media (max-width: 767px) {
    .pp-page { margin-left: 0; padding: 20px 16px 80px; height: auto; min-height: 100vh; overflow: auto; }
    .pp-card-header { padding: 24px 20px 16px; }
    .pp-card-body { padding: 0 20px 24px; }
    .pp-title { font-size: 20px; line-height: 30px; }
  }
`;

const PrivacyPolicyAboutView = ({ sections, navigate }) => (
  <>
      ...
      <div className="pp-page">
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 0 }}>
          <div style={{
            ...
            {/* Header */}
            <div className="pp-card-header" style={{ flexShrink: 0 }}>
            ...
            {/* Scrollable content */}
            <div className="custom-scroll pp-card-body" style={{ overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {sections.map((section, index) => (
                <div key={index}>
                  <p style={{ fontFamily: 'Montserrat', fontWeight: 700, fontSize: '16px', lineHeight: '24px', color: '#D9CA81', margin: '0 0 4px 0' }}>
                    {section.title}
                  </p>
                  <p style={{ fontFamily: 'Montserrat', fontWeight: 400, fontSize: '16px', lineHeight: '24px', color: '#FFFFFF', margin: 0, whiteSpace: 'pre-line' }}>
                    {section.body}
                  </p>
                </div>
              ))}
...
export default PrivacyPolicyAboutView;