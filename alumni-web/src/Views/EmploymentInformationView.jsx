            ...
            <div className="ei-card" ref={cardRef}>
              ...
              <div className="ei-fields">
                <div className="ei-field">
                  <span className="ei-label">
                    {getLabel("job_related_to_degree")}{" "}
                    <span className="ei-req">*</span>
                    {errors.has("job_related_to_degree") && (
                      <span className="ei-field-error">Required</span>
                    )}
                  </span>
                  <div className="ei-radio-group">
                    {["Yes", "No"].map((opt) => (
                      <label key={opt} className="ei-radio-label">
                        <input
                          type="radio"
                          name="job_related_to_degree"
                          value={opt}
                          checked={form.job_related_to_degree === opt}
                          onChange={() => set("job_related_to_degree", opt)}
                        />
                        {opt}
                      </label>
                    ))}
                ...
                <div className="ei-field">
                  ...
                  {form.employment_status === "Other" && (
                    <input
                      ...
                      type="text"
                      placeholder={
                        getPlaceholder("other_employment_status") ||
                        "Please specify"
                      }
                      ...
                      style={{
                        marginTop: "8px",
                        borderColor: errors.has("other_employment_status")
                          ? "#F87171"
                          : undefined,
                      }}
                    />
                ...
                <div className="ei-branch">
                  <div className="ei-field">
                    ...
                    <input
                      ...
                      type="text"
                      placeholder={
                        getPlaceholder("job_position") || "Enter your answer"
                      }
                  ...
                  <div className="ei-field">
                    ...
                    <input
                      ...
                      type="text"
                      placeholder={
                        getPlaceholder("company_name") || "Enter your answer"
                      }
                  ...
                  <div className="ei-field">
                    ...
                    <SelectDropdown
                      value={form.type_of_industry}
                      onChange={(v) => set("type_of_industry", v)}
                      industryOptions={industryOptions}
                      placeholder={
                        getPlaceholder("type_of_industry") || "Select industry"
                      }
                    />
                  </div>
                  <div className="ei-field">
                    <span className="ei-label">
                      {getLabel("location_of_employment")}{" "}
                      <span className="ei-req">*</span>
                  ...
                  <div className="ei-field">
                    <span className="ei-label">
                      {getLabel("reason_for_job")}{" "}
                      <span className="ei-req">*</span>
                      {errors.has("reason_for_job") && (
                        <span className="ei-field-error">Required</span>
                      )}
                    </span>
                    <div className="ei-radio-group">
                      {reasonsForJob.map((opt) => (
                        <label key={opt} className="ei-radio-label">
                          <input
                            ...
                            onChange={() => set("reason_for_job", opt)}
                          />
                          {opt}
                        </label>
                      ))}
                    ...
                    {form.reason_for_job === "Other" && (
                      <input
                        ...
                        type="text"
                        placeholder={
                          getPlaceholder("other_reason_for_job") ||
                          "Please specify"
                        }
                        value={form.other_reason_for_job}
                        onChange={(e) =>
                          set("other_reason_for_job", e.target.value)
                        }
                        onFocus={onFocus}
                        onBlur={onBlur}
                        style={{
                          marginTop: "8px",
                          borderColor: errors.has("other_reason_for_job")
                            ? "#F87171"
                            : undefined,
                        }}
                      />
              ...
              {showUnemployedFields && (
                <div className="ei-branch">
                  <div className="ei-field">
                    <span className="ei-label">
                      {getLabel("reasons_unemployed")}{" "}
                      <span className="ei-req">*</span>
                      {errors.has("reasons_unemployed") && (
                        <span className="ei-field-error">Required</span>
                      )}
                    </span>
                    <div className="ei-radio-group" style={{ gap: "16px" }}>
                      {unemployedReasons.map((reason) => (
                        <label key={reason} className="ei-radio-label">
                          <input
                            type="radio"
                            name="reasons_unemployed"
                            value={reason}
                            checked={form.reasons_unemployed === reason}
                            onChange={() => set("reasons_unemployed", reason)}
                          />
                          {reason}
                        </label>
                      ))}
                    ...
                    {form.reasons_unemployed === "Other" && (
                      <input
                        ...
                        type="text"
                        placeholder={
                          getPlaceholder("other_reason_unemployed") ||
                          "Please specify"
                        }
                        value={form.other_reason_unemployed}
                        onChange={(e) =>
                          set("other_reason_unemployed", e.target.value)
                        }
                        onFocus={onFocus}
                        onBlur={onBlur}
                        style={{
                          marginTop: "8px",
                          borderColor: errors.has("other_reason_unemployed")
                            ? "#F87171"
                            : undefined,
                        }}
                      />
