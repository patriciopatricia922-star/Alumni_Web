...
const LockIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <rect x="5" y="11" width="14" height="10" rx="2" stroke="#FFFFFF" strokeWidth="1.8" />
    <path d="M8 11V7a4 4 0 0 1 8 0v4" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" />
  </svg>
);
  ...
  >
    ...
    <div className="lgn-floating-card">
      ...
      <div className="lgn-card-body" style={{ alignItems: 'center' }}>
        ...
        {/* Error banner */}
        {error && (
          <div className="lgn-error-banner" style={{ width: '100%', boxSizing: 'border-box' }}>
            <p>{error}</p>
          </div>
        )}
