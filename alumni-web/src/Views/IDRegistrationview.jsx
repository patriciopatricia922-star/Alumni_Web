...
const IDRegistrationView = ({
  ...
  // ── Local state: which legal modal is open ──────────────────────────────
    ...
    <>
      <div style={{ width: '100%', height: isModal ? 'auto' : '100vh', background: '#002263', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Arimo,Arial,sans-serif', overflow: isModal ? 'visible' : 'hidden' }}>
        ...
        <div className="aid-card">
          ...
          {/* ── Terms checkbox ─────────────────────────────────────────────── */}
          {/*
            Both links now call setLegalModal() instead of navigating.
            The isModal flag is no longer relevant here — the modal approach
            works identically on the full-page route and inside a parent modal.
          */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}>
            ...
            <label htmlFor="terms-id" style={{ fontFamily: 'Arimo,Arial', fontWeight: 400, fontSize: '13px', lineHeight: '20px', color: '#FFFFFF', cursor: 'pointer' }}>
              ...
              <button
                ...
                style={{ background: 'none', border: 'none', padding: 0, color: '#D9CA81', fontFamily: 'Arimo,Arial', fontSize: '13px', fontWeight: 700, cursor: 'pointer', textDecoration: 'none' }}
              >
                Terms of Service
              </button>
              {' '}and{' '}
      ...
      {/* ── Legal modals — rendered outside the scrollable card so they sit above everything ── */}
