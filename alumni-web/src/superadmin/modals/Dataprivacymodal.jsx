        ...
        <div className="dpa-header">
          <div className="dpa-icon-wrap" aria-hidden="true">
            ...
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 2L4 5.5V11c0 4.418 3.358 8.55 8 9.93C19.642 19.55 23 15.418 23 11V5.5L12 2z"
                stroke="#003ea6" strokeWidth="1.75" strokeLinejoin="round"
              />
              <path
                d="M9 12l2 2 4-4"
                stroke="#003ea6" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"
              />
            </svg>
          </div>
