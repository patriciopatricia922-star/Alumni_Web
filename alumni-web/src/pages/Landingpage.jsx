  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#FFFFFF', fontFamily: 'Arial, sans-serif' }}>
      <style>{`
        ...
        .lp-nav { position: fixed; top: 0; left: 0; width: 100%; z-index: 50; transition: background 0.3s, border-color 0.3s; }
        ...
        .lp-nav-inner { max-width: 1280px; margin: 0 auto; padding: 0 43px; height: 64px; display: flex; align-items: center; justify-content: space-between; }
        ...
        .lp-nav-links button { background: none; border: none; cursor: pointer; font-family: 'Arial'; font-size: 16px; font-weight: 400; letter-spacing: 0.4px; color: #FFFFFF; transition: color 0.2s; padding: 0; }
        .lp-nav-links button:hover { color: #D9CA81; }
        .lp-nav-actions { display: flex; align-items: center; gap: 16px; }
        .lp-btn-login { padding: 8px 16px; background: #002263; border: 0.8px solid rgba(255,255,255,0.55); border-radius: 8px; font-family: 'Arial'; font-size: 14px; font-weight: 400; letter-spacing: 0.35px; color: #FFFFFF; cursor: pointer; transition: background 0.2s; }
        .lp-btn-login:hover { background: #001a4d; }
        .lp-btn-register { padding: 8px 16px; background: #DAA520; border: none; border-radius: 8px; font-family: 'Arial'; font-size: 14px; font-weight: 400; letter-spacing: 0.35px; color: #00072D; cursor: pointer; transition: background 0.2s; }
        ...
        .lp-hamburger span { display: block; width: 24px; height: 2px; background: #FFFFFF; border-radius: 2px; transition: all 0.3s; }
        .lp-mobile-menu { display: none; flex-direction: column; background: #002263; padding: 16px 43px 24px; gap: 16px; border-top: 1px solid rgba(255,255,255,0.1); }
        .lp-mobile-menu.open { display: flex; }
        .lp-mobile-menu button { background: none; border: none; cursor: pointer; font-family: 'Arial'; font-size: 16px; color: #FFFFFF; text-align: left; padding: 4px 0; }
        .lp-mobile-menu .lp-mobile-actions { display: flex; gap: 12px; padding-top: 8px; }
        .lp-section-title { font-family: 'Arial'; font-weight: 700; font-size: 48px; line-height: 48px; color: #101828; margin: 0 0 16px; text-align: center; }
        .lp-section-subtitle { font-family: 'Arial'; font-size: 20px; line-height: 28px; color: #4A5565; margin: 0 auto; text-align: center; max-width: 768px; }
        .lp-card { background: #FFFFFF; border: 0.8px solid rgba(0,0,0,0.1); border-radius: 14px; padding: 24px; transition: box-shadow 0.2s; }
        .lp-card:hover { box-shadow: 0 4px 20px rgba(0,0,0,0.08); }
        .lp-card h3 { font-family: 'Arial'; font-weight: 700; font-size: 20px; line-height: 28px; color: #0A0A0A; margin: 0 0 8px; }
        .lp-card p  { font-family: 'Arial'; font-size: 16px; line-height: 24px; color: #4A5565; margin: 0; }
        .lp-card .date { font-family: 'Arial'; font-size: 14px; line-height: 20px; color: #35408E; margin: 8px 0 0; }
        .lp-view-all { padding: 8px 32px; height: 48px; background: #002263; border: none; border-radius: 8px; color: #FFFFFF; font-family: 'Lexend', Arial; font-size: 16px; font-weight: 400; cursor: pointer; transition: background 0.2s; }
        .lp-view-all:hover { background: #001a4d; }
        .lp-cards-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin-bottom: 48px; }
        .lp-stats-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 32px; max-width: 1216px; margin: 0 auto; }
        .lp-why-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: start; }

        /* ── Footer ── */
        .lp-footer-inner { max-width: 1280px; margin: 0 auto; padding: 48px 64px 32px; display: flex; flex-direction: row; align-items: center; justify-content: space-between; gap: 80px; }
        .lp-footer-logo { flex-shrink: 0; width: 260px; height: 260px; display: flex; align-items: center; justify-content: center; margin-left: 40px; }
        .lp-footer-contact { flex: 0 1 auto; }
        ...
        @media (max-width: 1024px) {
          ...
          .lp-footer-inner { padding: 36px 32px 28px; gap: 48px; }
        }
        @media (max-width: 768px) {
          ...
          .lp-footer-inner { flex-direction: column; align-items: flex-start; gap: 32px; padding: 36px 24px 28px; }
          .lp-footer-logo { width: 160px; height: 160px; margin-left: 0; }
        }
        @media (max-width: 480px) {
          ...
          .lp-footer-inner { padding: 28px 16px 24px; gap: 24px; }
          .lp-footer-logo  { width: 130px; height: 130px; }
          section { padding-left: 16px !important; padding-right: 16px !important; }
        }

        /* ── Hero ── */
        .lp-hero { width: 100%; height: 100vh; min-height: 500px; position: relative; background-size: cover; background-position: center; }
        .lp-hero-content { position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 130px 5vw 40px; box-sizing: border-box; text-align: center; }
        .lp-hero-title-block { flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; }
        .lp-hero-subtitle { font-size: clamp(14px, 1.8vw, 24px) !important; line-height: 1.4 !important; letter-spacing: 0.1em !important; }
        .lp-hero-title    { font-size: clamp(36px, 7vw, 96px) !important; line-height: 1.2 !important; letter-spacing: 0.05em !important; white-space: nowrap; }
        .lp-explore-more { flex-shrink: 0; display: flex; flex-direction: column; align-items: center; cursor: pointer; gap: 4px; margin-top: auto; margin-bottom: 16px; }
        .lp-explore-more p { font-family: Arial; font-size: clamp(13px, 1.2vw, 16px); color: #FFFFFF; margin: 0; letter-spacing: 0.4px; }
      `}</style>
      ...
      <section className="lp-hero" style={{ backgroundImage: `url(${capBg})` }}>
        ...
        <div className="lp-hero-content" style={{ zIndex: 1 }}>
          ...
          <div className="lp-explore-more" onClick={() => document.getElementById('stats')?.scrollIntoView({ behavior: 'smooth' })}>
            <p>Explore More</p>
