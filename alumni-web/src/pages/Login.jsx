...
const labelStyle = {
  fontFamily: 'Montserrat', fontWeight: 400, fontSize: '11px',
...
const Login = () => {
  ...
  return (
    <>
      ...
      <div style={{ width: '100%', height: '100vh', background: '#002263', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Montserrat, Arial, sans-serif', overflow: 'hidden' }}>
        ...
        <div className="login-card" style={{ background: 'rgba(13,19,56,0.25)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '15px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '16px 20px 10px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
            ...
            <div style={{ width: '80%', background: 'rgba(243,243,245,0.17)', borderRadius: '10px', padding: '2px', display: 'flex' }}>
              <Link to="/signup" style={{ flex: 1, textDecoration: 'none' }}>
                <button style={{ width: '100%', height: '24px', background: 'transparent', borderRadius: '8px', border: 'none', fontFamily: 'Arial', fontSize: '12px', color: '#FFFFFF', cursor: 'pointer' }}>
                  Sign up
                </button>
              </Link>
              <button style={{ flex: 1, height: '24px', background: '#155DFC', boxShadow: '0px 4px 8px rgba(0,0,0,0.1)', borderRadius: '8px', border: 'none', fontFamily: 'Arial', fontSize: '12px', color: '#FFFFFF', cursor: 'pointer' }}>
                Log in
              </button>
            </div>
          </div>
          ...
          <div style={{ padding: '0 20px', flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <button style={{ width: '50%', height: '42px', background: 'rgba(243,243,245,0.17)', border: '1.23674px solid rgba(0,0,0,0.25)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', cursor: 'pointer', marginBottom: '12px' }}>
              ...
              <span style={{ fontFamily: 'Montserrat', fontSize: '13px', color: '#FFFFFF' }}>with Google</span>
            </button>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px', width: '100%' }}>
              <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)' }} />
              <span style={{ fontFamily: 'Montserrat', fontSize: '11px', color: '#FFFFFF' }}>OR</span>
              <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)' }} />
            </div>
          </div>
          ...
          <div style={{ margin: '0 5% 5%', flex: 1, background: 'rgba(13,19,56,0.25)', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0px 4px 4px rgba(0,0,0,0.25)', borderRadius: '12px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            <div style={{ padding: '14px 18px 10px', flexShrink: 0, textAlign: 'center' }}>
              <h3 style={{ fontFamily: 'Montserrat', fontWeight: 700, fontSize: '17px', color: '#FFFFFF', margin: '0 0 4px 0' }}>Welcome Back</h3>
              <p style={{ fontFamily: 'Montserrat', fontSize: '12px', color: 'rgba(255,255,255,0.7)', margin: 0 }}>Please enter your details to log in</p>
            </div>
            ...
            <div style={{ padding: '4px 18px 18px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                ...
                <div style={{ textAlign: 'right', marginTop: '6px' }}>
                  <Link to="/forgot-password" style={{ fontFamily: 'Montserrat', fontSize: '11px', color: '#D9CA81', textDecoration: 'none' }}>Forgot Password?</Link>
                </div>
              </div>
              ...
              <p style={{ fontFamily: 'Montserrat', fontSize: '12px', lineHeight: '40px', color: '#FFFFFF', textAlign: 'center', margin: 0 }}>
