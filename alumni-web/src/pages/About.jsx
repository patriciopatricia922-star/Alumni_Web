      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{fontFamily:'Arimo',fontWeight:400,fontSize:isMobile?'13px':'15px',color:'rgba(255,255,255,0.5)',margin:'0 0 20px 0',textAlign:'center'}}>Learn more about the platform</p>
            ...
            {/* Links */}
            <div style={{background:'rgba(13,19,56,0.4)',border:'1px solid rgba(255,255,255,0.1)',borderRadius:'14px',padding:isMobile?'18px 20px':'26px 28px'}}>
              {links.map((link,i)=>(
                <React.Fragment key={i}>
                  <button onClick={link.action} style={{width:'100%',display:'flex',alignItems:'center',justifyContent:'space-between',background:'none',border:'none',cursor:'pointer',padding:'3px 0'}} onMouseEnter={e=>e.currentTarget.style.opacity='0.75'} onMouseLeave={e=>e.currentTarget.style.opacity='1'}>
                    <span style={{fontFamily:'Arimo',fontWeight:700,fontSize:isMobile?'14px':'16px',color:'#FFFFFF'}}>{link.label}</span>
                  ...
                  {i < links.length-1 && <div style={{width:'100%',height:'1px',background:'rgba(255,255,255,0.08)',margin:'14px 0'}}/>}
                </React.Fragment>
              ))}
            </div>
