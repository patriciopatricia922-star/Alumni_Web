    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#002263' }}>
      ...
      <div style={{ marginLeft: '229px', flex: 1, padding: '37px 51px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '31px' }}>
          <div style={{ position: 'relative', width: '547px', background: 'rgba(13,19,56,0.4)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '14px', padding: '34px 38px 40px', boxSizing: 'border-box' }}>
            ...
            {/* Title */}
            <h2 style={{ fontFamily: 'Arimo', fontWeight: 700, fontSize: '19px', lineHeight: '20px', color: '#FFFFFF', margin: '0 0 8px 0', textAlign: 'center' }}>About AlumnAI</h2>
            <p style={{ fontFamily: 'Arimo', fontWeight: 400, fontSize: '15px', lineHeight: '20px', color: 'rgba(255,255,255,0.5)', margin: '0 0 24px 0', textAlign: 'center' }}>Learn more about the platform</p>

            {/* App Info Card */}
            <div style={{ background: 'rgba(13,19,56,0.4)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '14px', padding: '32px 24px', marginBottom: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
              <div style={{ width: '90px', height: '90px', background: 'linear-gradient(180deg, #002263 0%, rgba(0,69,201,0.05) 100%)', border: '1.24px solid rgba(255,255,255,0.15)', boxShadow: '0px 10px 15px -3px rgba(43,114,251,0.25), 0px 4px 6px -4px rgba(217,202,129,0.1)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <p style={{ fontFamily: 'Arimo', fontWeight: 400, fontSize: '17px', lineHeight: '28px', color: '#FFFFFF', textAlign: 'center', margin: 0 }}>
            ...
            {/* Links Card */}
            <div style={{ background: 'rgba(13,19,56,0.4)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '14px', padding: '26px 28px' }}>
              {links.map((link, i) => (
                <React.Fragment key={i}>
                  <button
                    onClick={link.action}
                    style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'none', border: 'none', cursor: 'pointer', padding: '3px 0' }}
                    onMouseEnter={e => e.currentTarget.style.opacity = '0.75'}
                    onMouseLeave={e => e.currentTarget.style.opacity = '1'}
                  >
                    <span style={{ fontFamily: 'Arimo', fontWeight: 700, fontSize: '16px', lineHeight: '20px', color: '#FFFFFF' }}>{link.label}</span>
