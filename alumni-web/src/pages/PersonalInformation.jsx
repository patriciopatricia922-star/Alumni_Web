...
const Field = ({ label, children, mb = '20px', flex }) => (
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#002263' }}>
      ...
      <div style={{
        ...
        flex: 1,
        padding: isMobile ? '24px 16px' : `37px ${hPad}`,
        position: 'relative',
        ...
        <div style={{
          ...
          <div style={{
            ...
            padding: isMobile ? '24px 20px 32px' : '29px 33px 40px',
            gap: '13px',
            width: '100%', maxWidth: '733px',
            ...
            <div style={{ textAlign: 'center', marginBottom: '8px' }}>
              <h2 style={{
                ...
                fontSize: isMobile ? '18px' : '20px', lineHeight: '30px',
              ...
              <p style={{
                fontFamily: 'Arimo, Arial', fontWeight: 400,
                fontSize: isMobile ? '13px' : '15px', lineHeight: '20px',
            ...
            {loading ? (
              <div style={{ textAlign: 'center', padding: '40px 0' }}>
                <span style={{ fontFamily: 'Arimo, Arial', fontSize: '14px', color: 'rgba(255,255,255,0.5)' }}>
                  Loading...
                </span>
              </div>
            ) : (
              <>
                ...
                {/* First + Middle Name — stacks on mobile */}
                <div style={{
                  display: 'flex',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px' }}>
                  ...
                  >
                    <span style={{ fontFamily: 'Arimo, Arial', fontWeight: 600, fontSize: '14px', color: '#FFFFFF' }}>
                      Change Password
                    </span>
